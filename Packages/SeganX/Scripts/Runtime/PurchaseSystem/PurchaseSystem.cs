...
namespace SeganX
{
    ...
    public class PurchaseSystem : MonoBehaviour
    {
        ...
        private static CallbackCaller purchaseCallback = new CallbackCaller();
        private static CallbackCaller consumeCallback = new CallbackCaller();
        private static CallbackCaller queryCallback = new CallbackCaller();
        ...
        {
            DontDestroyOnLoad(GameManager.Game.gameObject.AddComponent<PurchaseSystem>());
        }
            ...
            public static void Initialize(string key)
            {
                ...
                BazaarPlugin.IABEventManager.purchaseSucceededEvent = (res) =>
                {
                    ...
                    if (Payload.IsValid(res.DeveloperPayload))
                        Online.Purchase.End(Online.Purchase.Provider.Cafebazaar, Version, res.ProductId, res.PurchaseToken, (success, payload) => purchaseCallback.Call(success && payload == res.DeveloperPayload, res.PurchaseToken));
                    else
